...
/// `filename`, `path`, `metadata`) that the Astra SLOP converter uses to
...
pub enum ContentBlock {
    ...
    ///
    /// Optional metadata fields are used by the Astra SLOP converter to
    ...
    /// - `path`: file path on the Astra Computer filesystem
