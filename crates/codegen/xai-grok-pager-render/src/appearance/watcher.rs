...
//!
//! In dev mode, watches ~/.astra/pager.toml for changes and hot-reloads.
...
///
/// In dev mode: reads from ~/.astra/pager.toml, watches for changes.
...
impl ConfigWatcher {
    ...
    ///
    /// - In dev mode: reads/creates ~/.astra/pager.toml, watches for changes
