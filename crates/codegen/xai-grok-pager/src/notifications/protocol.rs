...
fn notification_sequence(
    ...
    Some(match protocol {
        ...
        // OSC 777 already uses the tab title as subtitle, so keep "Astra".
        ...
        NotificationProtocol::Osc777 => format!("\x1b]777;notify;Astra;{body}\x1b\\").into(),
...
mod tests {
    ...
    fn emit_enqueues_bytes_on_writer_queue() {
        ...
        assert_eq!(payload.data(), "\x1b]777;notify;Astra;body\x1b\\".as_bytes());
    }
    ...
    fn notification_sequence_osc99_and_osc777_strip_controls() {
        ...
        assert_eq!(osc777.as_ref(), "\x1b]777;notify;Astra;body\x1b\\");
    }
