...
Learn how to install, configure, and extend Astra, the terminal-based AI coding assistant from Astra.
...
Automate, script, and integrate Astra with other systems.

| # | Document | Description |
|---|----------|-------------|
| 14 | [Headless Mode and Scripting](14-headless-mode.md) | `astra -p`, output formats, CI/CD integration, and piping |
