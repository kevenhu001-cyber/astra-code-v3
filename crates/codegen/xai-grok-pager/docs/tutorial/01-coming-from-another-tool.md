...
Fear not — your settings, rules, and skills come with you. Astra
...
writes the items you selected into your `.astra` config. Re-run it anytime.
...
Run **`astra inspect`** in a repo to see every rules file, skill, and MCP
server Astra picked up, tagged with where it came from. Each compat source
