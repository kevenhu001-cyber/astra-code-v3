...
Want Astra working on a feature while you (or another Astra session) work on
...
- **From the shell:**
  ...
  ```bash
  astra --worktree=my-feature "refactor the auth module"
  ```
...
- Run two or three Astra sessions on the same repo simultaneously.
