...
Astra knows its own capabilities and can configure itself. Try:
...
## Teach Astra your project: AGENTS.md

Drop an `AGENTS.md` file in your repo root with build commands, conventions,
and gotchas. Astra reads it automatically in every session — it's the single
