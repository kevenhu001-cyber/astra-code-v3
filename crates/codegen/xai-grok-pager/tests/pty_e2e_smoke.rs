...
#[path = "pty_e2e/connect_wizard_three_step_flow.rs"]
mod connect_wizard_three_step_flow;
...
mod welcome_screen;
#[path = "pty_e2e/welcome_screen_astra_wordmark_renders_correctly.rs"]
mod welcome_screen_astra_wordmark_renders_correctly;
