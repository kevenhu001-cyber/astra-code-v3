...
//! OS-level sandboxing for Astra via [nono](https://crates.io/crates/nono).
//!
...
mod tests {
    ...
    /// Create a temp workspace whose `.astra/sandbox.toml` contains `toml_body`.
