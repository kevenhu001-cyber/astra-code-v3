...
//!    `~/.astra/logs/unified.jsonl` file (best-effort; ships to GCS
...
pub(crate) fn record_auth_401(
    ...
    // Sink 1 -- local file (~/.astra/logs/unified.jsonl) + scrubbed
...
mod tests {
    ...
    /// nothing from a developer's actual `~/.astra/auth.json` leaks in.
