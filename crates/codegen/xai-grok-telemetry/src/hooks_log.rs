...
//!
//! ```bash
//! GROK_HOOKS_LOG=1 grok              # enable, write to ~/.astra/logs/hooks.log
//! GROK_HOOKS_LOG=/tmp/h.log grok     # write to custom path
//! GROK_HOOKS_LOG=0 grok              # explicitly disable
//! tail -f ~/.astra/logs/hooks.log     # watch in another terminal
//! ```
...
///
/// Writes to `~/.astra/logs/hooks.log` (or custom path via `GROK_HOOKS_LOG`).
