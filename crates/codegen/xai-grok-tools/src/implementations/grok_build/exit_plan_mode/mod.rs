...
//! ## Plan File
//!
//! The plan file path defaults to `.astra/plan.md` relative to the session
...
mod tests {
    ...
    async fn exit_with_plan_content() {
        ...
        let plan_dir = tmp.path().join(".astra");
        ...
        match result {
            ExitPlanModeOutput::PlanReady {
                ...
                assert!(plan_file_path.ends_with(".astra/plan.md"));
            }
    ...
    async fn sends_plan_mode_exited_notification_with_content() {
        ...
        match notification {
            ToolNotification::PlanModeExited(exited) => {
                ...
                assert!(exited.plan_file_path.ends_with(".astra/plan.md"));
            }
    ...
    async fn prompt_format_includes_plan_content() {
        ...
        assert!(prompt.contains(".astra/plan.md"));
