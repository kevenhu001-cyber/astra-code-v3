...
///
/// Supported variables (Astra-native names + compat aliases):
///
...
It has multiple lines."#;
    ...
    fn test_build_skill_message_exact_format() {
        ...
        let expected = "\
<skill name=\"commit\" description=\"Create a git commit\" path=\"/home/user/.astra/skills/commit/SKILL.md\">
# Git Commit Skill
...
<skill name=\"empty\" description=\"An empty skill\" path=\"/skills/empty/SKILL.md\">
    ...
    fn test_build_skill_message_multiline_content() {
        let skill = SkillInfo {
            ...
            path: "/repo/.astra/skills/review/SKILL.md".to_string(),
            ..SkillInfo::default()
        };
        ...
        let expected = "\
<skill name=\"review\" description=\"Review code\" path=\"/repo/.astra/skills/review/SKILL.md\">
# Code Review
...
- No warnings
    ...
    fn test_substitutions_skill_dir() {
        ...
        apply_substitutions(
            ...
            None,
            &SubstitutionContext {
                skill_dir: Some("/home/user/.astra/skills/deploy"),
                ..Default::default()
            },
        );
        assert_eq!(
            content,
            "Config at /home/user/.astra/skills/deploy/config.json"
        );
    }
...
Review code.
    ...
    fn test_build_skill_information_multi() {
        ...
        let refs = vec![
            SkillRef {
                name: "review",
                path: "/project/.astra/skills/review/SKILL.md",
            },
            SkillRef {
                name: "lint",
                path: "/project/.astra/skills/lint/SKILL.md",
            },
        ];
        let result = build_skill_information(&blocks, &refs);
        assert!(result.starts_with("<skill_information>\n"));
