...
mod tests {
    ...
    fn test_metadata_serialization() {
        let meta = OverlayMetadata {
            ...
            mount_target: PathBuf::from("/home/user/.astra/worktrees/abc"),
    ...
    fn test_metadata_deserialization_from_fixture() {
        let json = r#"{
            ...
            "mount_target": "/home/user/.astra/worktrees/abc123",
    ...
    fn test_metadata_scan_finds_matching_target() {
        ...
        let json = r#"{
            ...
            "lower_dir": "/var/lib/repo-fuse/instance/fuse-lower",
            "mount_target": "/home/user/.astra/worktrees/wt1",
        ...
        assert_eq!(
            meta.mount_target,
            PathBuf::from("/home/user/.astra/worktrees/wt1")
        );
