...
fn id_from_path_strips_worktree_prefix_and_hashes_full_path() {
    let p = Path::new("/home/.astra/worktrees/myrepo/worktree-019caa03");
    assert_id_shape(&id_from_path(p), "019caa03");
    assert_id_shape(
        &id_from_path(Path::new("/home/.astra/worktree_pool/inst/a1b2c3")),
        "a1b2c3",
    );
...
fn same_basename_worktrees_in_different_repos_coexist() {
    ...
    let path_a = "/home/.astra/worktrees/repo-a/session/wt-abc";
    let path_b = "/home/.astra/worktrees/repo-b/session/wt-abc";
