...
//! `https://api.topodrive.top/v1/stt` and `wss://api.topodrive.top/v1/stt`.
//!
//! Official catalog (25 languages):
//! <https://docs.topodrive.top/developers/model-capabilities/audio/speech-to-text#supported-languages>
//!
...
/// Official Astra STT languages (docs.topodrive.top), sorted by English name.
///
...
mod tests {
    ...
    fn catalog_matches_public_docs_exactly() {
        ...
        assert_eq!(
            ours, docs,
            "STT_LANGUAGES drifted from docs.topodrive.top supported languages"
        );
    }
